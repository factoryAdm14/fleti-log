...
@section('content')
    <div class="pix-wrap">
        <div class="pix-card">
            <h1 class="pix-title">PIX Mercado Pago</h1>
    ...
    <script>
        ...
        function pollStatus() {
            fetch(@json(route('mercadopago_pix.status')) + '?payment_id=' + paymentId, {
