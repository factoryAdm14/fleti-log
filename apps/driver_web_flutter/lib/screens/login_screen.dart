          ...
          child: ConstrainedBox(
            ...
            child: ModernCard(
              child: Column(
                ...
                children: [
                  Text('Fleti Motorista', style: Theme.of(context).textTheme.headlineSmall),
                  const SizedBox(height: 8),
                  const Text('Entre para receber corridas e entregas'),
                  ...
                  const SizedBox(height: 12),
                  SecondaryButton(label: 'Cadastrar-se', onPressed: () => context.go('/register')),
                ],
              ),
            ),
          ),
